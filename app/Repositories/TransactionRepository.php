...
class TransactionRepository implements TransactionRepositoryInterface
{
    ...
    public function create(array $data)
    {
        ...
        try {
            ...
            $transaction->code = 'BLUEE-' . str_pad(mt_rand(1, 99999), 5, '0', STR_PAD_LEFT);
    ...
    private function calculateShippingAndTax(array $data, float $subtotal, int $weight): array
    {
        ...
        $response = Http::asForm()->withHeaders(['key' => env('KEY_RAJA_ONGKIR'), 'Content-Type' => 'application/x-www-form-urlencoded'])->post('https://rajaongkir.komerce.id/api/v1/calculate/domestic-cost', [
            'origin' => $origin,
        ...
        return [
            ...
            'grand_total' => round($subtotal * 0.11 + $shippingCost),
        ];
    }
}
