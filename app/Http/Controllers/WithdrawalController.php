...
class WithdrawalController extends Controller
{
    ...
    public function getAllPaginated(Request $request)
    {
        ...
        try {
            $withdrawals = $this->withdrawalRepository->getAllPaginated($request['search'] ?? null, $request['row_per_page']);

            return ResponseHelper::jsonResponse(true, 'Data retrieved successfully.', PaginateResource::make($withdrawals, WithdrawalResource::class), 200);
        } catch (\Exception $e) {
    ...
    {
        try {
            $withdrawals = $this->withdrawalRepository->getAll($request->search, $request->limit, true);

            return ResponseHelper::jsonResponse(true, 'Data retrieved successfully.', WithdrawalResource::collection($withdrawals), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function store(WithdrawalStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Withdrawal successfully', new WithdrawalResource($withdrawal), 201);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function approve(WithdrawalApproveRequest $request, string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Withdrawal of funds was successfully approved.', new WithdrawalResource($withdrawal), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
